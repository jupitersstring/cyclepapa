...
def main():
    ...
    for i, s in enumerate(U):
        ...
        if (datetime(2026,7,3) - ldt).days > 10: continue
        pdict = dict(prices)
        chg12 = None
        for off in range(15):
    ...
    # Export
    with open("/home/user/cyclepapa/data/master_scan_jul2026.csv","w",newline="") as f:
        w = csv.writer(f)
    ...
    print(f"\nExported -> data/master_scan_jul2026.csv")
