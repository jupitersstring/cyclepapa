...
- 66,858 issuers, 93,511 securities, 565,070 aliases (FMP symbol, exchange-qualified `EPA:LOCAL`, bare tickers where unambiguous, `CIK…`, old tickers).
...
|---|---|---|
| MOST_ASYMMETRIC.xlsx | 2,628 | 15 |
| OTC_BOOK.xlsx | 310 | 0 |
| cyclepapa_risk_reward_workbook.xlsx | 1,283 | 65 |

Unresolved samples (headers / non-tickers included): AAQL, ADX:EAND, AECOM, AIDIGONG, ALB-PA, APTOF, ASOS, AZLUY, BCBA, BMV:AZTECA, BXCAP, CIMG, CLBZ, CNDIF, CONOCOPHILLIPS, CONTEL, CSE:HAYL, CSE:HNB, CSE:SAMP, CUX, CVW, CWLXF, DEVSF, DSE:ISLAMIBANK, EUROEYES, FMP, FULLSHARE, GAPACK, GSE, GSE:MTNGH, GSE:RBGH, GSE:SOGEGH, GTCO, HANAFINANCIALGR, HDKSOE, HMM, IBK, IMMUNOTECH-B, KEPCO, LGCHEM
...
p_b examples: DXF 1.68 vs 0.11; HOVR 8.52 vs 1.05; SVRE 0.54 vs 0.11; INR 1.38 vs 0.33; MAAS 13.15 vs 4.82; CRNX 7.55 vs 2.95; WSHP 20.35 vs 9.04; ATAI 15.42 vs 7.30
...
|---|---|---|---|---|---|---|---|---|
| MOST_ASYMMETRIC.xlsx | 2,622 | 100% | 92% | 92% | 90% | 38% | 62% | 46% |
| OTC_BOOK.xlsx | 305 | 98% | 57% | 57% | 55% | 12% | 79% | 10% |
| cyclepapa_risk_reward_workbook.xlsx | 1,104 | 73% | 41% | 41% | 41% | 14% | 77% | 19% |
...
| 2026-09-25 | quote_store | 27,849 |

Facts rows this run: 584,231.
