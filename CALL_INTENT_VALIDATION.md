...
Generated 2026-09-25 by `call_intent_model.py`. Calls analysed: 17777 (2381 names). Labelled: 9541; train < 2025-06-01: 4588, test >= 2025-06-01: 4953. Test base rate (ACTED): 30.9%.
...
| v2, DEEP-DISCOUNT calls only (P/B <= 0.8 at the call; n=1079, base 0.291) | 0.644 |
| rule score, companies NOT already shrinking share count | 0.601 |

Top decile hit-rate (test): rule 52.7% vs base 30.9% (lift 1.71x); baseline+language 60.8% (lift 1.97x).
...
| H4 CEO and CFO both commit | 267 | +4.5% | -2.1% | 174 | +5.3% | -4.7% |
| contrast: no shareholder-action language | 502 | +4.0% | -6.2% | 359 | +35.1% | -12.3% |
...
|---|---|---|---|---|
| Q1 | 1945 | +17.9% | -10.3% | 12.9% |
| Q2 | 1946 | -3.0% | -8.7% | 14.1% |
| Q3 | 1946 | -3.5% | -6.9% | 12.1% |
| Q4 | 1946 | -3.9% | -6.5% | 11.4% |
