...
FACTOR_LOADINGS: dict[str, dict[str, float]] = {
    ...
    "TKA":    {"eu_sovereign_industrial_policy": 0.7, "european_steel_cycle": 0.8, "cbam_enforcement": 0.5, "kretinsky_execution": 0.5},
    "OHLA":   {"spanish_recovery": 0.9, "european_construction_cycle": 0.6},
    "SAB":    {"spanish_recovery": 0.5, "european_bank_consolidation": 0.8},
    "FLG":    {"us_bank_recap": 0.9, "us_cre_cycle": 0.7},
    "YPF":    {"argentine_sovereign": 0.9, "vaca_muerta_production": 0.7, "milei_policy_continuity": 0.6},
    "GTCO":   {"emerging_market_bank": 0.9, "naira_fx_volatility": 0.7, "nigerian_sovereign": 0.5},
    "6305":   {"asian_governance_reform": 0.9, "fiea_amendment_timing": 0.6, "construction_cycle": 0.4},
    "241560": {"asian_governance_reform": 0.8, "korean_value_up_regime": 0.7, "construction_cycle": 0.4},
    "DSI":    {"emerging_market_bank": 0.4, "gcc_infrastructure_cycle": 0.8},
...
CLUSTERS = {
    ...
    "US_bank_recap":           ["us_bank_recap", "us_cre_cycle"],
    "Spanish_recovery":        ["spanish_recovery", "european_construction_cycle", "european_bank_consolidation"],
    "Argentine_sovereign":     ["argentine_sovereign", "vaca_muerta_production", "milei_policy_continuity"],
    "EM_bank":                 ["emerging_market_bank", "naira_fx_volatility", "nigerian_sovereign",
                                "gcc_infrastructure_cycle"],
    "Asian_governance_reform": ["asian_governance_reform", "fiea_amendment_timing", "korean_value_up_regime",
                                "construction_cycle"],
