...
ARCH_FAMILY = {
    ...
    'arch_xr_cash_leads_book': 'deep_value', 'arch_coiled_base': 'inflection', 'arch_base_ignition': 'inflection', 'arch_xr_peer_margin_gap': 'inflection',
}
