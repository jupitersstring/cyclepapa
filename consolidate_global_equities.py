...
cols = ["name", "_universe", "sector", "last_close", "rs_rank_max",
        ...
        "adv_20d_millions", "adv_20_over_60", "adv_slope_pct_wk",
        "adv_accel", "log_adv_20d",
        ...
        "mv_dist_from_ath_pct", "mv_at_ath",
        "mv_3w_tight", "mv_power_trend",
        "mv_buyable_gap_up", "mv_climax_top_warning",
        "mv_stage4_count", "mv_stage4_pass",
        "mv_close_at_252d_high", "mv_bow_tie",
        "mv_vcp_with_volume", "mv_high_tight_flag",
        "mv_right_side_base", "mv_constructive_base",
        "mv_sma200_acceleration", "mv_sma200_accelerating_up",
        "mv_pct_above_pivot", "mv_in_buy_zone",
        "mv_setup_premium",
