...
def main():
    ...
    for i, s in enumerate(U):
        ...
        if (datetime(2026,9,23) - ldt).days > 10: continue
        pdict = dict(prices)
        chg12 = None
        for off in range(15):
    ...
    # Export
    with open("/home/user/cyclepapa/data/master_scan_sep23_2026.csv","w",newline="") as f:
        w = csv.writer(f)
    ...
    print(f"\nExported -> data/master_scan_sep23_2026.csv")
