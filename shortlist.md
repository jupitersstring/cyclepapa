# Best Opportunities Today — Global Shortlist (May 2026 vintage)

Applied output of the framework in `capital_structure_screening.md`,
synthesizing the 2024–2026 recap vintage. Ranked by the four-question
gate:

1. *Rescue for whom?* (Bucket — §9)
2. *How good a deal is it?* (Scorecard — §2)
3. *Is it asymmetrically priced?* (Triangulation — §8; **alignment-gap
   ratio** is the headline number — §2.1 dim. 9)
4. *Which tranche, in which window?* (Fulcrum + Condition 7 — §4, §2.2)

Each candidate is tagged with:
- **Bucket** (A/B/C) — seat selection
- **Archetype** (A–G, §3.1) — deal mechanic
- **Gap** — alignment-gap ratio (anchor entry ÷ current market)
- **C7** — Condition-7 inflection status (visible / pending / unclear)

**Caveats.** Live verification needed for: current fulcrum-debt prices,
Form 4 / SEDI / PDMR / SAST / MAR Art. 19 insider transactions, most
recent 13F / TR-1 / EAR / SAST institutional changes, HY OAS backdrop,
and the specific stage of each deal's event timeline. Treat the ranking
as the *pipeline*; sizing requires the daily refresh.
...
**Bucket A · Archetype A + F · Gap ≈ 2.9× · C7 pending**

The single cleanest live analogue to the Rolls-Royce 2020 / 3i 2009
playbook in the global universe.

- **Mechanic.** Nov–Dec 2025 €1.5bn raise: **€828m reserved increase at
  €4.00** (French State APE 29.65%, Bharti Space 17.9%, UK Gov 10.9%,
  CMA CGM 7.5%, FSP) + **€670m 8-for-11 rights at €1.35** (133%
  subscribed). New €500m RCF + €400m TL, 3+1+1y. PF leverage ~2.5× by
  FY25–26. Lockup 180 days; no PIK warrants or rescue fees.
- **Alignment gap.** Anchor €4.00 vs. market ~€1.40 = **2.9×**. Sovereign
  + strategic consortium holds ~66% of pro-forma equity at the higher
  price. This is the hardest revealed-preference signal in the universe
  right now.
- **Condition 7.** IRIS² European sovereign LEO constellation (€10.6bn
  programme), GEO/LEO integration with OneWeb, defence broadband demand,
  geopolitical Starlink-alternative narrative. Inflection still pending —
  market still prices dilution + IRIS² capex through 2029 + competitive
  dread.
- **Trade.** Listed common on Euronext (also LSE secondary). Best entry
  near rights-clearing price; supplement via any nil-paid window.
  Asymmetry ratio ~3–5× to reserved-investor entry value plus plausible
  LEO re-rate; ~40% downside if IRIS² slips materially.
- **Kill criteria.** IRIS² programme delay >12 months; sovereign anchor
  exits lockup early; OneWeb integration write-down; SES/Starlink
  pricing war intensifies.

---

### 2. Worldline — Euronext: WLN (France)

**Bucket A · Archetype A · Gap ≈ 6.9× · C7 pending**

A near-carbon copy of the Eutelsat playbook two months later, with the
largest alignment gap in the screen.

- **Mechanic.** Mar 2026 €500m raise: **€108m reserved at €2.75**
  (Bpifrance, Crédit Agricole, BNP Paribas — 10% premium to 30-day VWAP)
  + **6-for-1 rights at €0.202** (85.8% discount). BFCM bought SIX
  Group's rights for €36m. Three French anchors committed 27.5% capital
  / 36.6% votes to carry the deal. All common equity; no fees.
- **Alignment gap.** Anchor €2.75 vs. market ~€0.40 = **6.9×** — *the
  largest gap in the universe*. The three anchors paid roughly 7× the
  current market.
- **Condition 7.** European payments cycle turn, "North Star 2030"
  execution, M&A interest in Ingenico-era assets. Still in the
  governance-churn / fraud-contagion (Wirecard memory, Adyen
  compression) discount zone.
- **Trade.** Listed common at ~€0.40. Asymmetry ~3–5× versus a 4–5×
  EV/EBITDA normalised payments multiple.
- **Kill criteria.** Major customer loss; further governance change;
  plan execution slips; second dilutive event before 2027 FCF visible.
...
The cleanest precedent in the Chinese property unwind — the first major
developer to *fully equitise offshore debt* with founder alongside
creditors.

- **Mechanic.** 5 Nov 2025 HK High Court sanctioned second offshore RX:
  **US$9.55bn offshore debt** wiped through two MCB tranches (HK$6.80
  and HK$3.85, conversion 23 Dec 2025). Founder **Sun Hongbin took
  ~23% of the new MCBs himself with a 6-yr lock-up**, plus 7% ESOP for
  ~500 staff. Earlier Jan 2025 onshore deal cut CNY15.4bn (US$2.1bn)
  by 50%.
- **Alignment.** Founder taking nearly a quarter of the new convertible
  alongside the creditors who are converting — strongest cross-class
  alignment among all defaulted Chinese developers.
- **Condition 7.** First-mover deleveraged platform in still-distressed
  Chinese property cycle; any policy stimulus or consolidator interest
  is the inflection.
- **Trade.** Post-conversion HKEX common at HK$1.49–1.75; US$1.9–2.3bn
  cap with conversion overhang at lower prices. Asymmetry 3–4× to
  stabilised-property multiple; 60–70% downside if China property
  worsens.
- **Kill criteria.** Onshore restructuring fails; project completion
  defaults; PRC policy stimulus indefinitely deferred.
...
The cleanest US national-champion liquidity panic in this window — and
the only one where bankruptcy was avoided entirely.

- **Mechanic.** 24 Sept 2024: **62.16m-share follow-on at $9.25 → $558m
  net** + 90% sale of American Savings Bank for $384m = $942m fresh
  liquidity. Nov 2024 settlements crystallised **$1.916bn of Maui
  wildfire tort** (four annual $479m payments). Hawaii Act 258 (2025)
  authorised $500m wildfire-mitigation securitisation and forward
  liability cap. First $479m settlement payment cleared via SPV April
  2026.
- **Alignment.** Pure common-equity raise to existing and new public
  holders, no rescue-lender priming, no warrants. The cleanest "old
  equity participated at market discount" template in this list.
- **Condition 7 (most advanced).** Trades at 1.6× P/B and 21× trailing
  earnings vs. regulated-utility peers at 1.8–2.5× P/B. Authorised ROE
  9.5% vs. realised 6.1% → ~50% EPS upside on closing the gap alone,
  plus eventual return of dividend.
- **Trade.** Listed common ~$15. Asymmetry ~2.5–3× to $30–40 on
  liability-cap legislation + rate normalisation; ~30% downside if cap
...
Sovereign-anchored Malaysian oilfield-services recap of unusual scale.

- **Mechanic.** PN17 plan, Bursa-approved 30 Jun 2025, court-sanctioned
  Mar 2025: **99.99% capital reduction + 20:1 share consolidation**;
  RM10.76bn debt restructured; **RM1.1bn fresh equity via Redeemable
  Convertible Loan Stock subscribed by Malaysia Development Holding
  (MoF vehicle, 33% post-conversion)**, alongside RM2bn RCUIDS to
  creditors. PNB retains 40.4%; Shamsuddin promoter family 9.2%.
- **Condition 7.** Deepwater capex cycle inflecting; 20-country
  oilfield-services platform; Angola contract loss being worked out.
- **Trade.** Pre-consolidation shares 3.5–4.5 sen (~RM643–827m mkt cap).
  Option-like residual equity. Asymmetry 4–6× if RM12bn → RM6bn debt
  and cycle holds.
...
Textbook fallen national-champion casino rescue; the anchor accepted
current market pricing rather than paying a premium (gap inverted vs.
Eutelsat/Worldline).

- **Mechanic.** 7 Apr 2025 binding term sheet (shareholder-approved
  99.4% on 25 Jun 2025): **A$300m subordinated convertible notes** from
  Bally's (A$200m) + Mathieson Investment Holdings (A$100m) at A$0.08
  conversion / 9% coupon + senior debt extension. Bally's takes 37.7%
  Tranche 1 → up to 56.7% fully diluted; Mathieson 10% → ~23%; Steve
  McCann CEO, Mathieson Jr Chair.
- **Condition 7.** AML penalty resolution; Queens Wharf ramp; consumer
  recovery.
- **Trade.** Listed common A$0.10–0.13; mkt cap ~A$730m vs. three casino
  operating platforms. Asymmetry 2–3× to clean-up multiple.
...
Largest Brazilian aligned-promoter recap in the screen.

- **Mechanic.** Judicial recovery homologated 26 Feb 2024 + R$24.46bn
  capital increase approved 21 May 2024 + 100:1 reverse split. Gross
  debt R$45.2bn → **R$1.7bn**; book equity –R$30.4bn → +R$5.7bn with
  positive net cash. **3G trio (Lemann/Telles/Sicupira) injected R$12bn**
  taking reference-shareholder ownership 30.1% → 49.2%.
- **Condition 7.** Same-store sales +13.6% Q3 2024 but digital GMV still
  –45.5%; RJ exit targeted Feb 2026; HNT divestiture planned;
  R$10.3bn one-time RJ profit.
- **Trade.** B3 common. Asymmetry 2–4× on full RJ exit + digital
  stabilisation.
...
First Chinese developer to use UK Part 26A Restructuring Plan with
cross-class cramdown.

- **Mechanic.** UK sanctioned 3 Feb 2025; HK sanctioned 19 Feb 2025.
  **US$6bn offshore debt compromised → ~US$2.2bn new debt + MCBs**.
  **China Life (~15%) and Dajia Insurance (~15%) — both state-aligned
  insurers — retain 53.8% of equity** with 2-yr retention undertakings.
  SOE status preserved.
- **Condition 7.** China property policy support; onshore restructuring
  close; SOE financing access.
- **Trade.** HKEX listed common; mkt cap ~US$700m–1bn against deeply
  discounted property book. Asymmetry 2–4× on China property
  stabilisation.
- **Kill criteria.** Project completion failure; onshore creditor
  rebellion; going-concern audit flag escalates.

### 10. Metro Bank Holdings — LSE: MTRO (UK)

**Bucket A · Archetype G · C7 partial**

Cleanest live bank capital-cliff recap in developed markets.

- **Mechanic.** Oct 2023: **£325m equity + £600m debt refi**. **Jaime
  Gilinski Bacal (Spaldy Investments) injected £102m → 53% controlling
  stake**; £175m new MREL; call dates +5 years. £3bn mortgage book sold
  to NatWest.
- **Condition 7.** Treasury repricing; asset rotation into higher-yield
  SME/consumer; MREL cost savings. Pollen Street/BC Partners reportedly
  bid at low value, rejected — signals Gilinski's price floor.
- **Trade.** LSE common at 0.6–0.75× tangible book with recovered
  capital position. Asymmetry ~2–3× to peer-multiple normalisation.
- **Kill criteria.** UK mortgage softness; Gilinski governance
  overhang; further capital event.

### 11. Synlait Milk — NZX/ASX: SML (New Zealand)

**Bucket A · Archetype D + A · Gap 1× (anchor at market) · C7 pending**

Clean NZ national-dairy-champion strategic rescue with two customer-
aligned anchors.

- **Mechanic.** NZ$217.8m equity completed 1 Oct 2024: **Bright Dairy
  NZ$185m at NZ$0.60 (39% → 65.25%)** + **a2 Milk NZ$32m at NZ$0.43
  (19.8% strategic)** + NZ$130m Bright Dairy bridge (Jul 2024) +
  SML010 bond redemption Nov 2024.
- **Condition 7.** WMP price recovery; customer wins; H1 FY25 turnaround
  visible.
- **Trade.** NZX listed common NZ$0.50–0.65; mkt cap ~NZ$280–370m
  against NZ$1.6bn revenue. Asymmetry 2–3×.
- **Kill criteria.** Loss of a2 exclusivity from Jan 2025; farmer-supply
  tension; FX adverse.

---

## Tier 3 — Asymmetric option-sized (one weaker leg)

### 12. Wolfspeed — NYSE: WOLF (US)

**Bucket C → B (new post-prepack common) · Archetype F · C7 pending**

- 30 Jun 2025 prepack → emerged 29 Sept 2025. **$4.6bn debt eliminated
  (~70% reduction)**; $275m new 2L convertible.
- **Renesas Electronics took 38.7% of new equity as strategic anchor**;
  convertible holders 56.3%; 3–5% legacy "gift."
- $698.6m CHIPS Act 48D refund landed Dec 2025; Q3 fiscal 2026 cash
  $1.5bn.
- Sole US-based 200mm SiC fab — onshoring optionality.
- Asymmetry 3–5× on SiC cycle + Renesas/auto offtake ramp; 60–70%
  downside on EV slowdown + Chinese SiC dumping.

### 13. iHeartMedia — NASDAQ: IHRT (US)

**Bucket A · Archetype C · Gap n/a · C7 pending**

- Dec 2024 debt exchange swept **92.2% of $4.8bn debt** into 2029/30/31
  notes + 2L 2030; wall pushed three years; net debt –$440m.
- Old equity untouched; Pittman family aligned.
- Equity stub <$300m on $3.8bn revenue (0.05× P/S); EV/EBITDA ~7–8×.
- Inflection: $200m cost-out; digital/podcast >30% of EBITDA growing
  double-digits; rate-cut refi math.
- **Asymmetry 4–6× option-like upside** if leverage to 4× by 2027; ~0
  if 2028 maturities arrive without further deleveraging.

### 14. Lumen Technologies — NYSE: LUMN (US)

**Bucket A · Archetype C/G · C7 visible (re-rate already partial)**

- 2024 out-of-court LME: **$15bn+ maturities pushed to 2029–2032** +
  $1.325bn new money + $1bn super-priority RCF; 2025–26 maturities
  $2.1bn → $0.6bn.
- Old equity untouched. **CEO Kate Johnson + CFO Stansbury bought stock
  through 2025**.
- Fitch/Moody's/S&P upgrades to IG-trajectory by Feb 2026.
- Inflection: **$5bn+ multi-year AI fibre contracts with MSFT/META/GOOG/
  AWS**; >2,000 Network-as-a-Service customers Q1 2026.
- Asymmetry ~2.5–3× despite +117% 1-yr TSR — partial re-rate already
  in price.

### 15. Calumet — NASDAQ: CLMT (US)

**Bucket A · Archetype B + C · C7 pending**

- Jul 2024 MLP-to-C-Corp conversion + **$1.44bn DOE Title XVII loan-
  guarantee conditional commitment (Oct 2024)**; $222m recourse paydown;
  $405m new 2031 notes. Recourse leverage 8.2× → **4.9×**; $80m annual
  interest savings.
- DOE backstop = strategic, mission-aligned anchor (US SAF national
  priority); founder/Borgmann backed.
- Hidden asset: **Montana Renewables**, Lazard hired to monetise;
  implied private-market value $2–3bn vs $3bn co. cap.
- MaxSAF 150 expansion online Q2 2026 (largest SAF in W. Hemisphere).
- Asymmetry 2–3× on monetisation; principal risk = 45Z PTC framework.

### 16. Aston Martin Lagonda — LSE: AML (UK)

**Bucket A · Archetype C · C7 pending**

- Nov 2024 £111m placing @ 100p + £100m senior secured notes 2029; Mar
  2025 Yew Tree placing 75m @ 70p (£52.5m, 7% premium) + £74m F1-team
  minority sale = £125m liquidity uplift.
- **Yew Tree (Stroll) → ~33%** alongside PIF, Geely, Mercedes — all
  common equity.
- Valhalla PHEV 2025; BEV pushed to 2026.
- Asymmetry 2–3× to luxury-spec re-rate. Sixth raise since 2020 — kill
  risks are further dilution, China weakness, EV strategy slippage.

### 17. Capital A Berhad — KLSE:CAPI (Malaysia)

**Bucket A · Archetype A + E · C7 pending**

- PN17 regularisation in execution: capital reduction + **distribution
  in-specie of 1.7bn AAX shares**; AAX RM1bn private placement;
  AirAsia Aviation transferred to AAX at RM6.8bn EV. PN17 uplift
  targeted Aug 2026.
- **Tony Fernandes + Kamarudin Meranun ~30% combined**.
- Secondary listings in HK (Q3 2026) + Nasdaq backdoor planned.
- Shares RM0.40–0.45 vs 52-wk range RM0.24–1.03 embed substantial AAX
  value.
- Asymmetry 2–3× on PN17 uplift + listings.

### 18. WW International — NASDAQ: WW (US)

**Bucket A (hybrid) · Archetype C/F · C7 pending**

- Prepack 6 May 2025 → emerged 24 Jun 2025. **$1.6bn secured debt
  collapsed to single $465m 2030 TL**. Creditors took 91%, **legacy
  equity unusually generous 9%**.
- Inflection: **GLP-1 pivot via Med+ partnerships with Novo Nordisk
  (Wegovy/Ozempic) and Lilly (oral semaglutide)**; $40m voluntary 2026
  debt prepayment; FY26 guidance reaffirmed; Clinical/Med+ subs +46%
  YoY Q1 2026.
- ~$10 vs $37 median analyst PT.
- **Asymmetry 5–10× option** if platform converts; 70–90% downside if
  GLP-1 cannibalisation outruns clinical growth.

### 19. Embracer / Fellowship Entertainment — OM: EMBRAC B (Sweden)

**Bucket B (founder across spincos) · Archetype F · C7 pending**

- 3-way demerger announced 22 Apr 2024: **Asmodee spun 7 Feb 2025**,
  **Coffee Stain spun 11 Dec 2025**, residual **Fellowship Entertainment**
  holds Middle-earth/LOTR + ~300 game IPs.
- 44 studios closed; 4,532 staff cut. Net debt SEK 16.75bn → <SEK 8bn.
- **Founder Lars Wingefors holds across all three vehicles** via
  Embracer AB.
- Asymmetry 1.5–2.5× on SOTP closure.

### 20. Sibanye-Stillwater — JSE: SSW / NYSE: SBSW (South Africa)

**Bucket B (convertible) · Archetype B · C7 pending**

- Nov 2023 **$500m senior unsecured convertible** (4.25%, $1.34/ZAR 24.58
  conversion, 32.5% premium); shareholder approval 98.74% on 28 May 2024.
- R1.8bn SA gold prepayment + €500m Keliber Green Loan; covenant uplift
  to 3.5× to Jun 2025.
- Multi-commodity (PGM / gold / lithium / Keliber lithium online 2026 /
  Reldan recycling).
- Asymmetry 2–3× on PGM + lithium recovery.

### 21. Nigerian banks basket — GTCO, Zenith, Fidelity, Access

**Bucket A · Archetype G · C7 partial**

- CBN-mandated ₦500bn capital floor for international-licensed banks by
  31 Mar 2026 drove **>₦4.6tn sector-wide raises**:
  - Access ₦351bn rights @ ₦19.75 (oversubscribed)
  - Zenith ₦350bn hybrid rights + public @ ₦36/₦36.50
  - **GTCO ₦209bn local + ₦366bn LSE listing @ ₦70 (2.28bn shares)**
  - UBA ₦397bn (2 tranches)
  - Fidelity ₦175.85bn + private placement
- Sector Tier-1 ↑ to ₦20.22tn (+21% YoY); CAR 15.20%; profit growth 62%.
- Top names at single-digit P/E and <1× book despite >20% ROE.
- Asymmetry 2–4× in USD-adjusted terms on Naira stabilisation.
- **Top picks: GTCO, Zenith, Fidelity.**

### 22. Borr Drilling — NYSE/OSE: BORR

**Bucket A · Archetype B · C7 pending**

- Jul 2025 $102.5m equity + $200m super-senior RCF expansion; Dec 2025
  $165m 10.375% sr secured notes 2030 to fund five jack-up acquisitions.
- **Tor Olav Trøim founder transitioned to Exec Chairman**.
- Asymmetry 2–3× on jack-up day-rate normalisation in ME/Brazil.

### 23. Hycroft Mining — NASDAQ: HYMC (US)

**Bucket A · Archetype B · C7 pending**

- 9 Oct 2025 public offering 23.08m @ $6.50 ($150m gross); **Eric Sprott
  anchored, added more April 2026 as 10%+ owner**.
- Post-deal: $189m cash, no debt; 16.4m oz Au M&I; 562.6m oz Ag M&I
  (55% resource upgrade).
- Asymmetry 3–5× if sulphide commercialises; 60–80% downside on
  pilot failure.

### 24. Drake & Scull International — DFM: DSI (UAE)

**Bucket A · Archetype E · C7 pending**

- 1 Apr 2024 capital restructuring wrote off **AED 4.18bn debt (90%)**;
  10% converted to 5-yr mandatory convertible sukuk; AED 600m capital
  increase. **Tabarak Investment anchored** (existing strategic since
  2017). Trading resumed 21 May 2024 after 5-yr halt.

### 25. Light SA — B3: LIGT3 (Brazil)

**Bucket A · Archetype A + E · C7 pending**

- RJ plan approved 29 May 2024, confirmed 18 Jun 2024; **~R$11bn debt
  restructured**; capital increase up to R$1.5bn (R$1bn anchor). Net
  debt ~R$4.5bn. ANEEL concession renewal is the key external catalyst.
  Collection rates 98.8%.
...
- **Kenya Airways** — earliest stage of strategic-investor search;
  negative book equity
- **Liontown / Vulcan / Sayona / Piedmont** — aligned sovereign/strategic
  cornerstones but lithium-cycle bottleneck
- **Garuda Indonesia** — pending IDR20tn Danantara injection; execution
  risk
- **Hertz (HTZ)** — Pershing 19.8% disclosed Apr 2025 has narrowed the
  asymmetry; ~1.5–2× residual
- **Endo Inc / Mallinckrodt (NDOI)** — post-merger Bain + Silver Point;
  ~2–3× on NYSE up-list + spin
- **Japan Display (6740)** — Ichigo Trust 78%; minority float watch
- **GOL (GOLL53/54)** — Abra Group ~80% post-Ch.11; concentrated
  control; ~2–3× pending Azul merger noise
- **Sunrise (SUNN)** — Liberty Global spin; ~1.5–2× peer normalisation

---

## False friends — old equity is toast (do not confuse with above)
...
2U Inc (private LLC); Audacy (private); Enviva (equity converted to
out-of-money warrants Dec 2024); Diamond Sports / Main Street Sports
Group (private); SunPower (363 sale); Sunnova (Jun 2025 Ch.11 → asset
sale); Mallinckrodt legacy MNKKQ; Endo legacy ENDPQ (cancelled); WeWork
...
Steinhoff (delisted, private Ibex Topco); Crédito Real / Unifin /
AlphaCredit (full wipeouts); NMC Health / Finablr (delisted, fraud
unwind); Vanquis Banking (no material recap); Trinseo (creditor-driven
bond exchange, no equity injection); Greek banks (HFSF exit complete,
re-rated past condition 7); **Banca Monte dei Paschi** (Mediobanca offer
secured Sep 2025 — fully re-rated; now a consolidator).
...
## Pattern recognition — what's actually working in this cycle

The May 2026 vintage has produced a **distinctive French sovereign-
strategic playbook (Archetype A)** that is now the cleanest archetype in
the world: state development banks and strategic industrial anchors
write common equity at agreed prices that sit multiples above the
parallel rights-issue clearing price, creating a hard valuation floor
against which the public stock looks visibly mispriced. **Eutelsat and
Worldline are the textbook examples.**
...
The **Chinese property complex bifurcates sharply** on backstop quality:
Sunac (founder takes 23% of MCBs) and Sino-Ocean (state insurers retain
53.8%) cleanly satisfy alignment while Logan, Agile, Kaisa, and CIFI
lean creditor-takeover.

The **Malaysian PN17 system** has produced two genuinely aligned recaps
(Sapura via sovereign MoF and Capital A via Fernandes promoter).

The **Nigerian banking complex** is a once-in-a-cycle regulator-forced
recap basket where the entire sector has been recapitalised at
...
pending)* — exactly the structural mispricing that defined Rolls-Royce
2020, ArcelorMittal 2016, and 3i 2009 in their respective cycles.
