...
**Universe size: 928 named candidates across 10 regions and 58 sectors.**
...
|---|---|---|---|
| **T0** | ≥ 0.80 | 88 | full YAML build + verify ASAP |
| **T1** | 0.55–0.80 | 140 | priority YAML build-out |
...
*52 names carry secondary archetype tags (e.g. A1+G).*
